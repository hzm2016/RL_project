...
def parse_args():
    ...
    parser.add_argument('--lambda', type=float, default=np.array([.2]))  # np.array([0., 0.2, 0.4])
    ...
    parser.add_argument('--all_algorithms', type=str, dest='all_algorithms', default=['AdvantageActorCritic', 'A2CExpected'])
